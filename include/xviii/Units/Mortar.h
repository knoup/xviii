...
{
public:
	Mortar(World& _world, boost::random::mt19937&, Player* _belongsToPlayer, TextureManager::Unit _texture, std::string _name, UnitType _type, UnitFamily _familyType, Direction _dir);
