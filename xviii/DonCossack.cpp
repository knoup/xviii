...
float DonCossack::getFlankModifier(UnitFamily _family, Modifier _flank) const{
...
Cavalry(_world, _mt19937, _belongsToPlayer, tm, fm, _dir, TextureManager::Unit::LCAV, UnitType::DON)
{
	deploymentCost = 3;
	limit = 5;
