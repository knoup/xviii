...
std::string Deli::attack(UnitTile* _unit, int distance){
	return _unit->attack(this, distance);
}

std::string Deli::attack(Infantry* inf, int distance){
...
std::string Deli::attack(Cavalry* cav, int distance){
...
std::string Deli::attack(Cuirassier* cuir, int distance){
...
std::string Deli::attack(Dragoon* drag, int distance){
...
std::string Deli::attack(LightCav* lcav, int distance){
...
std::string Deli::attack(Artillery* art, int distance){
...
std::string Deli::attack(Mortar* mor, int distance){
...
std::string Deli::attack(General* gen, int distance){
...
std::string Deli::attack(Akinci* aki, int distance){
...
std::string Deli::attack(Deli* deli, int distance){
