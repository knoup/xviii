...
float KhevMkhedrebi::getFlankModifier(UnitFamily _family, Modifier _flank) const{
...
Cavalry(_world, _mt19937, _belongsToPlayer, tm, fm, _dir, TextureManager::Unit::CUIR, UnitType::MKH)
{
	deploymentCost = 3;
	limit = 5;
