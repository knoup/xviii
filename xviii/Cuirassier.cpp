...
std::string Cuirassier::rotate(UnitTile::Direction _dir){
	if (hasRotated){
...
std::string Cuirassier::interactWithFriendly(UnitTile* _unit){
	return{};
}
...
std::string Cuirassier::attack(Deli* deli, int distance){
...
std::string Cuirassier::rangedAttack(UnitTile* unit, int distance){
	return{};
}